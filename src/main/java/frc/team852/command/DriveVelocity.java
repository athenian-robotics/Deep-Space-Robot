...
public class DriveVelocity extends Command {
    ...
    private static final Shuffle sLeftEncoder = new Shuffle(DriveVelocity.class, "leftEncoder", 0);
    private static final Shuffle sRightEncoder = new Shuffle(DriveVelocity.class, "rightEncoder", 0);
    ...
    private void prepare() {
        leftControl = new PIDController(
                ...
                sKd.get(),
                sKf.get(),
                RobotMap.leftEncoder, new SmoothSpeedOutput(RobotMap.leftDrive, 1, true));
        rightControl = new PIDController(
                sKp.get(),
                sKi.get(),
                sKd.get(),
                sKf.get(),
                RobotMap.rightEncoder, new SmoothSpeedOutput(RobotMap.rightDrive, 1, false));
    ...
    protected void execute() {
        ...
        sLeftEncoder.set(RobotMap.leftEncoder.getRate());
        sRightEncoder.set(RobotMap.rightEncoder.getRate());
        sEnabled.set(true);
    }
